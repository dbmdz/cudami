...
public class OceanTest extends BaseJsonSerializationTest {

  private Ocean createObject() {
    Ocean obj = new Ocean();
    obj.setLabel(new LocalizedText(Locale.ENGLISH, "Ocean"));
  ...
  public void testSerializeDeserialize() throws Exception {
    Ocean geoLocation = createObject();
    checkSerializeDeserialize(
        geoLocation, "serializedTestObjects/identifiable/entity/geo/location/Ocean.json");
  }
}
