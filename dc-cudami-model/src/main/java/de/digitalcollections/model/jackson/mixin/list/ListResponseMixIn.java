...
@JsonTypeInfo(use = Id.NAME, property = "listResponseType", visible = true)
@JsonSubTypes({
  @Type(value = BucketObjectsResponse.class, name = "BUCKET_OBJECTS_RESPONSE"),
  @Type(value = BucketsResponse.class, name = "BUCKETS_RESPONSE"),
  @Type(value = ListResponse.class, name = "LIST_RESPONSE"),
  @Type(value = PageResponse.class, name = "PAGE_RESPONSE"),
})
