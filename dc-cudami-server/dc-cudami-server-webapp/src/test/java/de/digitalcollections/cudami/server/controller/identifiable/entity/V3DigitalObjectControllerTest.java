...
public class V3DigitalObjectControllerTest extends BaseControllerTest {
  ...
  public void emptyCollectionsForDigitalObject(String path) throws Exception {
    ...
    previewImage.setUri(
        new URI("file:///cudami/image/jpg/2780/bee1/eeec/4b50/a95b/bba9/0793/fc6a/resource.jpg"));
    ...
    PageRequest pageRequest =
        new PageRequestBuilder().pageNumber(0).pageSize(1).filtering(filtering).build();
