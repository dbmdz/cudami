...
public class SubtopicController {
  ...
  public Subtopic addSubtopicToParentSubtopic(
          ...
          @PathVariable UUID parentSubtopicUuid,
          @ApiPathParam(name = "subtopicUuid", description = "The uuid of the subtopic") @PathVariable UUID subtopicUuid)
  ...
  public List<Entity> getEntities(
          @ApiPathParam(name = "uuid", description = "The uuid of the subtopic") @PathVariable UUID uuid) {
  ...
  @ApiMethod(
          description = "Remove child-relation of the given subtopic to the given parent subtopic")
  @DeleteMapping(
          value = {
            "/latest/subtopics/{parentSubtopicUuid}/subtopic/{subtopicUuid}",
            "/v2/subtopics/{parentSubtopicUuid}/subtopic/{subtopicUuid}"
          ...
          produces = MediaType.APPLICATION_JSON_VALUE)
  @ApiResponseObject
  Integer removeSubtopicFromParentSubtopic(
          @ApiPathParam(name = "parentSubtopicUuid", description = "The uuid of the parent subtopic")
          @PathVariable UUID parentSubtopicUuid,
          @ApiPathParam(name = "subtopicUuid", description = "The uuid of the subtopic") @PathVariable UUID subtopicUuid) {
    return service.removeFromParentSubtopic(subtopicUuid, parentSubtopicUuid);
  }
  ...
  @DeleteMapping(
          ...
          produces = MediaType.APPLICATION_JSON_VALUE)
  @ApiResponseObject
  Integer removeSubtopicFromParentTopic(
          @ApiPathParam(name = "topicUuid", description = "The uuid of the parent topic") @PathVariable UUID topicUuid,
          @ApiPathParam(name = "subtopicUuid", description = "The uuid of the subtopic") @PathVariable UUID subtopicUuid) {
    return service.removeFromParentTopic(subtopicUuid, topicUuid);
  }
