...
@SpringBootTest(
    ...
    classes = {CountryRepositoryImpl.class})
@DisplayName("The Country Repository")
class CountryRepositoryImplTest
    extends AbstractIdentifiableRepositoryImplTest<CountryRepositoryImpl> {
  @Autowired private IdentifierRepository identifierRepository;
  @Autowired private UrlAliasRepository urlAliasRepository;

  @BeforeEach
  public void beforeEach() {
    repo = new CountryRepositoryImpl(jdbi, cudamiConfig, identifierRepository, urlAliasRepository);
  }

  @Test
  @DisplayName("can save (create) a country")
  ...
  @Test
  @DisplayName("can update a country")
  void testUpdate() throws RepositoryException, ValidationException {
    ...
    Country beforeUpdate = createDeepCopy(geolocation);
