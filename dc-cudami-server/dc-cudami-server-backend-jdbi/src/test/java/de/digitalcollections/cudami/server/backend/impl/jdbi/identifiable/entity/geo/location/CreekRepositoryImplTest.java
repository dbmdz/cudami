...
@SpringBootTest(
    ...
    classes = {CreekRepositoryImpl.class})
@DisplayName("The Creek Repository")
class CreekRepositoryImplTest extends AbstractIdentifiableRepositoryImplTest<CreekRepositoryImpl> {
  @Autowired private IdentifierRepository identifierRepository;
  @Autowired private UrlAliasRepository urlAliasRepository;

  @BeforeEach
  public void beforeEach() {
    repo = new CreekRepositoryImpl(jdbi, cudamiConfig, identifierRepository, urlAliasRepository);
  }

  @Test
  @DisplayName("can save (create) a creek")
  ...
  @Test
  @DisplayName("can update a creek")
  void testUpdate() throws RepositoryException, ValidationException {
    ...
    Creek beforeUpdate = createDeepCopy(geolocation);
