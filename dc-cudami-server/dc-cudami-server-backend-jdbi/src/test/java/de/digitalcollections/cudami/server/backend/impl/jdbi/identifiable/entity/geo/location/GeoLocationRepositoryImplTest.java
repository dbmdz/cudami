...
@SpringBootTest(
    ...
    classes = {GeoLocationRepositoryImpl.class})
@DisplayName("The GeoLocation Repository")
class GeoLocationRepositoryImplTest
    extends AbstractIdentifiableRepositoryImplTest<GeoLocationRepositoryImpl<GeoLocation>> {
  ...
  void testUpdate() throws RepositoryException, ValidationException {
    ...
    GeoLocation beforeUpdate = createDeepCopy(geolocation);
