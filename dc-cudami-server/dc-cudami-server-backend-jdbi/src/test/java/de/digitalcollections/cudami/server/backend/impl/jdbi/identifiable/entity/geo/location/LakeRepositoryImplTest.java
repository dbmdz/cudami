...
@SpringBootTest(
    ...
    classes = {LakeRepositoryImpl.class})
@DisplayName("The Lake Repository")
class LakeRepositoryImplTest extends AbstractIdentifiableRepositoryImplTest<LakeRepositoryImpl> {
  @Autowired private IdentifierRepository identifierRepository;
  @Autowired private UrlAliasRepository urlAliasRepository;

  @BeforeEach
  public void beforeEach() {
    repo = new LakeRepositoryImpl(jdbi, cudamiConfig, identifierRepository, urlAliasRepository);
  }

  @Test
  @DisplayName("can save (create) a lake")
  ...
  void testUpdate() throws RepositoryException, ValidationException {
    ...
    Lake beforeUpdate = createDeepCopy(geolocation);
