...
@DisplayName("The StillWaters Repository")
class StillWatersRepositoryImplTest
    extends AbstractIdentifiableRepositoryImplTest<StillWatersRepositoryImpl> {
  ...
  public void beforeEach() {
    repo =
        new StillWatersRepositoryImpl(jdbi, cudamiConfig, identifierRepository, urlAliasRepository);
  }

  @Test
  @DisplayName("can save (create) a stillwaters")
  void testSave() throws RepositoryException, ValidationException {
    StillWaters geolocation =
        StillWaters.builder()
            .label("Test")
            .coordinateLocation(
  ...
  @Test
  @DisplayName("can update a stillwaters")
  void testUpdate() throws RepositoryException, ValidationException {
    ...
    StillWaters beforeUpdate = createDeepCopy(geolocation);
