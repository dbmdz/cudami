...
ALTER TABLE items
  ALTER COLUMN "language" TYPE varchar COLLATE "ucs_basic",
...
ALTER TABLE fileresources
  ALTER COLUMN filename TYPE varchar COLLATE "ucs_basic",
...
ALTER TABLE fileresources_linkeddata
  ALTER COLUMN context TYPE varchar(512) COLLATE "ucs_basic",
...
ALTER TABLE headwords
  ALTER COLUMN "label" TYPE varchar(256) COLLATE "ucs_basic",
...
ALTER TABLE identifiertypes
  ALTER COLUMN "label" TYPE varchar COLLATE "ucs_basic",
  ALTER COLUMN "namespace" TYPE varchar COLLATE "ucs_basic",
  ALTER COLUMN pattern TYPE varchar COLLATE "ucs_basic";

ALTER TABLE licenses
  ALTER COLUMN acronym TYPE varchar COLLATE "ucs_basic",
...
ALTER TABLE url_aliases
  ALTER COLUMN slug TYPE varchar(256) COLLATE "ucs_basic",
