...
@Repository
public class CountryRepositoryImpl extends GeoLocationRepositoryImpl<Country>
    implements CountryRepository {

  private static final Logger LOGGER = LoggerFactory.getLogger(CountryRepositoryImpl.class);

  public static final String MAPPING_PREFIX = "geo_ct";
  public static final String TABLE_ALIAS = "geo_ct";
  public static final String TABLE_NAME = "geo_countries";
  ...
  @Override
  public Country create() throws RepositoryException {
    return new Country();
  }
}
