...
public class SpringConfigBackendNeo4jForTest {
  ...
  public SessionFactory sessionFactory() {
    SessionFactory sessionFactory = new SessionFactory(getConfiguration(), "de.digitalcollections.cms.server.backend.impl.neo4j.model", "de.digitalcollections.cms.model.api");
