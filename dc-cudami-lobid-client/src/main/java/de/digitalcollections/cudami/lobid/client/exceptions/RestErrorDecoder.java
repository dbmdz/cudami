...
import de.digitalcollections.cudami.lobid.client.exceptions.client.ForbiddenException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.HttpClientException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.ImATeapotException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.ResourceException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.ResourceNotFoundException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.UnauthorizedException;
import de.digitalcollections.cudami.lobid.client.exceptions.client.UnavailableForLegalReasonsException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.BadGatewayException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.GatewayTimeOutException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.HttpServerException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.HttpVersionNotSupportedException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.NotImplementedException;
import de.digitalcollections.cudami.lobid.client.exceptions.server.ServiceUnavailableException;

public class RestErrorDecoder {
