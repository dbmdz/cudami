...
// same as OrderedList extension: just name and class name changed to match JSON "ordered_list" instead "orderedList" and "list_item" instead "listItem"
...
export { CustomOrderedList, CustomOrderedList as default, inputRegex };