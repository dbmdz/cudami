...
public class BTRequest extends PageRequest {
  ...
  public BTRequest(int offset, int limit, String sortProperty, String sortOrder, String sortLanguage) {
    super((int) Math.ceil(offset / limit), limit, List.of(Order.builder()
