...
public class UserServiceImpl implements UserService<User> {
  ...
  @Override
  public User save(User identifiable, Errors results) throws IdentifiableServiceException {
    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  }

  @Override
  public User update(User identifiable, Errors results) throws IdentifiableServiceException {
    throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  }
}
